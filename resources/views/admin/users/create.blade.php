@php
    $breadcrumbTitle     = __('admin.users.add_user');
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <small class="text-muted mt-1 d-block">
                                <i class="bi bi-info-circle me-1"></i>{{ __('admin.users.password_hint') }}
                            </small>
                            @error('password')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">{{ __('admin.users.role') }}</label>

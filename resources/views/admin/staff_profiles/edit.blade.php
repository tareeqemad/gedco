                        ...
                        <form action="{{ route('admin.staff-profiles.update', $profile) }}" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="family_notes" rows="3" class="form-control rounded-3 " placeholder="{{ __('admin.staff_profiles.edit_incidents_notes_placeholder') }}">{{ old('family_notes', $profile->family_notes) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12 {{ old('readiness', $profile->readiness) == 'not_ready' ? 'show' : 'hidden' }}" id="readiness-notes-field">
                                    ...
                                    <textarea name="readiness_notes" rows="4" class="form-control rounded-3 ">{{ old('readiness_notes', $profile->readiness_notes) }}</textarea>
                                </div>
                            </div>
